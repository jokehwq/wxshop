...
public class TopayServlet {
	 ...
	 *             if an error occurred
	 */
	public static String getPackage(List<Order> list,
		...
		w.setNetnum(session.getAttribute("netnum")+"");
		...
		int price = (int) (money * 100);
	/*	 String str = String.valueOf( price);//浮点变量a转换为字符串str
	        int idx = str.lastIndexOf(".");//查找小数点的位置
	        String strNum = str.substring(0,idx);//截取从字符串开始到小数点位置的字符串，就是整数部分
	        int  price1 = Integer.valueOf(strNum);*/
	     /*   int price = (int) (money * 100);*/
		   String totalFee = price + "";
		...
		String openId = s.getOppen_id(session);
		...
		reqHandler.init(wxSetting.getAppid(), wxSetting.getAppsecret(),
				wxSetting.getPartnerkey());

		String sign = reqHandler.createSign(packageParams);
		String xml = "<xml>" + "<appid>" + wxSetting.getAppid() + "</appid>"
