...
public class ExpressController {
	...
	public String insert(Express express) throws UnsupportedEncodingException {
		express.setExpress_name(java.net.URLDecoder.decode(
				express.getExpress_name(), "utf-8"));
	...
	public ModelAndView exp_choose(ModelAndView ml, Express express,
			String order_id) {
//		List<Express> list = expressService.select(express);
...
//		if (StringUtils.isNotEmpty(express_dm)
//				&& StringUtils.isNotEmpty(express_hm)) {
...
//		ml.addObject("order_id", order_id);
	...
	public String exp_show(String express_dm, String express_hm) {
		...
		String result = kdniaoTrackQueryAPI.getOrderTracesByJson(express_dm,
				express_hm);
