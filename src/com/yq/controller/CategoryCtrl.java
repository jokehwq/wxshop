...
public class CategoryCtrl {
	...
	public String insert(String ctg_name, String ctg_img, Integer status,
			Integer sort, String netnum) throws UnsupportedEncodingException {
	...
	public Object update(Integer ctg_id, String ctg_img, String ctg_name)
	...
	public ModelAndView ctgList(@RequestParam(defaultValue = "0") Integer ctg_id, HttpSession session) {
		...
		category.setNetnum(session.getAttribute("netnum")+"");
		...
		if (ctgList.size() > 0) {
			...
			goods.setType(1);
			goods.setNetnum(session.getAttribute("netnum")+"");
