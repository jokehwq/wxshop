...
document.body.addEventListener('touchmove',function(e){
                ...
                <ul class="con-right" style="/* margin-bottom: 49px; */overflow-y:scroll">
                    ...
                    <li class="con-right-con">
                        ...
                        <div class="right-con-p">
                            ...
                            <p class="p3 p-txt" style="float: left;" onclick="window.location.href='goodsListById.html?goods_id=${goodsList.goods_id}'"><span class="price-1" style="font-size: 18px">₫ ${goodsList.thePrice }</span></p>
   ...
   var data = '${goodsList}' ;
    for(var a = 0;a<data.length;a++){
    	console.log(data[a].goods_price);
    }
