...
<style>
	...
	/* .ssjg-ul1 li:nth-child(odd){
	    float: left !important;
	}
	.ssjg-ul1 li:nth-child(even){
...
<div class="sy-info1" style="border-bottom:4px solid #E6E6E6;">
        ...
        <c:forEach items="${hotGoodsList}" var="goodsList">
        	<li>
                ...
                <dl class="ssjg-dl1">
                    ...
                    <p class="ssjg-p1" style="margin-top:10px;"><span>₫ ${goodsList.thePrice}</span></p>
                    </dt>
        ...
        <c:forEach items="${map[gl]}" var="glist" begin="0" end="5">
        	<li>
                ...
                <dl class="ssjg-dl1">
                    ...
                    <p class="ssjg-p1" style="margin-top:10px"><span>₫ ${glist.thePrice}</span></p>
                    </dt>
    ...
    $(function(){
    	$(".ssjg-ul1 li:nth-child(even)").addClass('right');
    	$(".ssjg-ul1 li:nth-child(odd)").addClass('left');
    })
