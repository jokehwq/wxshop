...
<body>
	...
	function upPage() {
		if (currentPage > 1) {
			window.location.href = 'userList.html?currentPage='
					+ (parseInt(currentPage) - 1)+'&status=1'+'&netnum='+${netnum };
			return;
		}
	}
	function downPage() {
	...
	function fpage() {
		window.location.href = 'userList.html?currentPage=1'+'&status=1'+'&netnum='+${netnum };
		return;
	}
	function epage() {
		window.location.href = 'userList.html?currentPage=' + totalPage+'&status=1'+'&netnum='+${netnum };
		return;
	}
	function spage() {
		var seastr =$('#seastr').val();
		if (parseInt(seastr)< parseInt(totalPage)||parseInt(seastr)== parseInt(totalPage)) {
		window.location.href = 'userList.html?currentPage=' + seastr+'&status=1'+'&netnum='+${netnum };
		}
		return;
	}
