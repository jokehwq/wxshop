...
<body>
	...
	<div class="pd-20">
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l" id="btn"> <a href="goodsAddjsp.html"
	...
	$('#btn').html('<a href="goodsAddjsp.html?netnum='+netnum+'" class="btn btn-primary radius"> <i class="Hui-iconfont">&#xe600;</i>添加记录</a>')
	...
	function upPage() {
		if (currentPage > 1) {
			window.location.href = 'goodsList.html?currentPage='
					+ (parseInt(currentPage) - 1)+'&status=1&goods_name=' + encodeURIComponent(encodeURIComponent(goods_name))+'&netnum='+netnum;
			return;
		}
	}
	function downPage() {
	...
	function fpage() {
		window.location.href = 'goodsList.html?currentPage=1'+'&status=1&goods_name=' + encodeURIComponent(encodeURIComponent(goods_name))+'&netnum='+netnum;
		return;
	}
	function epage() {
		window.location.href = 'goodsList.html?currentPage=' + totalPage+'&status=1&goods_name=' + encodeURIComponent(encodeURIComponent(goods_name))+'&netnum='+netnum;
		return;
	}
	function spage() {
		var seastr =$('#seastr').val();
		if (parseInt(seastr)< parseInt(totalPage)||parseInt(seastr)== parseInt(totalPage)) {
		window.location.href = 'goodsList.html?currentPage=' + seastr+'&status=1&goods_name=' + encodeURIComponent(encodeURIComponent(goods_name))+'&netnum='+netnum;
		}
		return;
	}
	</script>
