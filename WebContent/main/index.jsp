...
<title>火云商城-后台管理</title>
</head>
<body>
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.3" href="main.html">&nbsp;&nbsp;&nbsp;火云商城</a> <a class="Hui-logo-m l" href="/" title="H-ui.admin"></a> <span class="Hui-subtitle l">V1.0</span>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a _href="ctgList.html?status=1&netnum=${netnum }" href="javascript:void(0)">分类查看</a></li>
					<li><a _href="goodsList.html?status=1&netnum=${netnum }" href="javascript:void(0)">商品查看</a></li>
				</ul>
			</dd>
		</dl>
		<!-- <dl id="menu-product">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="banList.html?status=1&netnum=${netnum }" href="javascript:void(0)"> 轮图查看</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a _href="secList.html?status=1&netnum=${netnum }" href="javascript:;">搜索查看</a></li>
				</ul>
			</dd>
		</dl>
		<!-- <dl id="menu-comments">
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a _href="orderList.html?netnum=${netnum }" href="javascript:;">订单查看</a></li>
				</ul>
			</dd>
		</dl>
		<%-- <c:if test="${admin.admin_id==1}"> --%>
		<!-- <dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a _href="userList.html?netnum=${netnum }" href="javascript:;">会员查看</a></li>
				</ul>
			</dd>
		</dl>
		<!-- <dl id="menu-article">
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					...
					<c:if test="${admin.username == 'superadmin'}">
						<li><a _href="addAdmin.jsp" href="javascript:;">添加账户</a></li>
						<li><a _href="showAdmin.jsp" href="javascript:;">商家账户</a></li>
					</c:if>
				</ul>
			</dd>
		</dl>
	...
	<div id="Hui-tabNav" class="Hui-tabNav">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="火云" data-href="#">火云</span><em></em></li>
			</ul>
		</div>
